...
export default function Home(){
  ...
  return <div className="min-h-screen bg-slate-950 text-white">
    ...
    <section className="border-y border-white/10 bg-white/[.025] px-5 py-10"><div className="mx-auto max-w-7xl"><div className="mb-6 flex items-end justify-between"><div><div className="text-xs uppercase tracking-[.3em] text-slate-500">The group</div><h2 className="mt-1 text-2xl font-bold md:text-3xl">Choose a company</h2></div><span className="text-sm text-slate-500">15 cards · 14 companies</span></div>
