...
const starterProjects = [
  ...
  { id: "xedruo", name: "Xedruo", type: "Platform", status: "Active", company: "xedruo" },
];
...
export default function DeveloperWorkstation(){
  ...
  function createProject(){ const name=window.prompt("Project name"); if(!name?.trim())return; const p={id:Date.now().toString(),name:name.trim(),type:"New project",status:"Draft",company}; setProjects(p=>[...p,p]); setSelected(p); }
