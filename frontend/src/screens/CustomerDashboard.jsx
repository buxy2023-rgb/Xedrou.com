...
const COMPANY_MODULES = {
  "xedruo-power-holdings": ["Group overview", "Company operations", "Finance", "Development", "Compliance", "Reports"],
  ...
  "heathrou": ["Find doctor", "Appointments", "Hospitals", "Pharmacy", "Prescriptions", "Health delivery"],
  ...
  "xedruo": ["Music distribution", "Releases", "Catalog", "Analytics", "Royalties", "Artist management"]
};
...
export default function CustomerDashboard() {
  ...
  useEffect(() => {
    if (!user) navigate(`/company/${encodeURIComponent(company[0])}`, { replace: true });
