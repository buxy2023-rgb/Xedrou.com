  ...
  if (selectedRole) {
    ...
    return <div className="min-h-screen bg-slate-950 p-5 text-white md:p-10"><div className="mx-auto max-w-lg">
      ...
      <div className="rounded-3xl border border-cyan-300/20 bg-white/5 p-7">
        ...
        {isGoogleRole ? <>
          <p className="mt-6 text-sm leading-6 text-slate-400">Use your own Google account. You do not need a separate Xedruo workforce password. Google verifies the account before Xedruo opens the assigned workstation.</p>
          ...
          <p className="mt-4 text-center text-xs text-slate-500">Use the Google/Gmail account authorized for your Xedruo role.</p>
        </> : <div className="mt-7 rounded-2xl border border-white/10 bg-slate-900 p-5"><LogIn className="text-cyan-300" size={22}/><h2 className="mt-3 font-semibold">Workforce sign-in</h2><p className="mt-2 text-sm leading-6 text-slate-400">Password workforce login has been retired for the Google-enabled roles.</p></div>}
      </div>
    </div></div>;
  }
